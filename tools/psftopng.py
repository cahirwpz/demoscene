...
class PSF(Mapping):
    ...
    def __init__(self, height, _char, _char_map):
        self.height = height
        self._char = _char
        self._char_map = _char_map
...
def readPSF1(f):
    ...
    _char = [array('B', f.read(height)) for i in range(glyphs)]
    _char_map = {}
    ...
    while True:
        ...
        if uchar == PSF1_SEPARATOR:
            ...
            _char_map[uchar] = index

    return PSF(height, _char, _char_map)
