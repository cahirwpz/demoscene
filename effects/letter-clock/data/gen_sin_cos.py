...
if __name__ == '__main__':
    ...
    print('')
    print("typedef struct {int x_cos[MOVEMENTS]; int y_sin[MOVEMENTS];} CircleMovements;")
    print('')
    ...
    for i in range(int(movements)):
        ...
        circle_movements[1]["x_cos"].append(int(big_r * math.cos((progress + math.pi) % (2 * math.pi))))
        circle_movements[1]["y_sin"].append(int(big_r * math.sin((progress + math.pi) % (2 * math.pi))))
